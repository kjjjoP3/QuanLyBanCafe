 ...
 * @author ACER NITRO 5
 */
public class thongTinNewDiag extends javax.swing.JDialog {
private byte[] personalImage;
    /**
     * Creates new form thongTinNVNEW
     */
    public thongTinNewDiag(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        txtNgaySinh.setText(shareHelper.sinhVienDangNhap.getNgaySinh());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(thongTinNewDiag.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                thongTinNewDiag dialog = new thongTinNewDiag(new javax.swing.JFrame(), true);
